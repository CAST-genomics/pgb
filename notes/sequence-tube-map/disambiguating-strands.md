...
are tried and as some of them fail. Migrated from the spike repo 2026-08-17.

> **A note, not a rule.** This is descriptive — it records what has been tried and what
> each proposal has to answer to, and it licenses nothing. The binding decisions are
> [`docs/adr/0001-sequence-tube-map-panel.md`](../../docs/adr/0001-sequence-tube-map-panel.md)
> (accepted cost 6 is this problem) and
> [`docs/adr/0002-webgl-band-renderer.md`](../../docs/adr/0002-webgl-band-renderer.md).
>
> Written in
...
Record: [`notes/2026-08-14-feeler-mode-on-the-gpu.md`](https://github.com/CAST-genomics/sequence-tube-map-spike/blob/main/notes/2026-08-14-feeler-mode-on-the-gpu.md).
