...
echo "  $OUTPUT_TBI"
echo ""
echo "Update data/test-local.json to use these files:"
echo "  \"url\": \"http://localhost:8000/data/genomes/$(basename "$OUTPUT_GZ")\""
echo "  \"indexURL\": \"http://localhost:8000/data/genomes/$(basename "$OUTPUT_TBI")\""
